  ...
  return (
    <section className="contact-section" id="contact">
      <div className="contact-section__top-content">
        <h2 className="contact-section__top-content__title">Interested in working together? Let’s discuss your project.</h2>
      ...
      <div className="contact-section__bottom-content">
        <div className="contact-section__bottom-content__copyright">
          ...
          <p className="contact-section__bottom-content__copyright__description">Jakub Trnčák © 2025 – Professional Web Developer | All rights reserved.</p>
        </div>
